...
export default function Home() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:py-16">
      <p className="mb-2 text-sm font-medium tracking-wide text-accent-strong">猫・犬の計算ツール集</p>
      ...
      <p className="mb-4 max-w-2xl text-base leading-relaxed text-muted">
        猫・犬の年齢を人間年齢に換算したり、体重とライフステージから1日の給餌量の目安を計算できる無料ツール集です。
        実際に猫を飼っている運営者が、実体験をもとに作っています。
      </p>
      <TrustBadges />
